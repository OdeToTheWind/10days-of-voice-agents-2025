...
export const WelcomeView = ({
  ...
  return (
    <div ref={ref}>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden bg-[#030261]">
      ...
      <section className="relative z-10 flex min-h-svh w-full flex-col items-center justify-center text-center">
        ...
        <MotionText
          className="mb-8 bg-gradient-to-r from-white/90 via-white to-white/80 bg-clip-text text-5xl font-bold tracking-tight text-transparent md:text-5xl lg:text-6xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
            duration: 0.7,
        ...
        >
          Where Ancient Magic Rises. And Your Decisions Forge Destiny
        </MotionSubtext>

        {/* Pill badge with slide-up */}
        <motion.div
          className="mt-6 rounded-full bg-white px-6 py-1.5 text-xs font-semibold uppercase tracking-wide text-[#030261] shadow-sm"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
            duration: 0.5,
        ...
        >
          Your Voice is the Spark. The Dragon's Story Begins.
        </motion.div>
        ...
        >
          <Button
            ...
            size="lg"
            onClick={onStartCall}
            className="mt-8 w-64 border-none bg-white font-mono text-[#2b23aa] transition-all hover:scale-105 hover:bg-gray-100"
          >
            {startButtonText}
          </Button>
        </motion.div>
